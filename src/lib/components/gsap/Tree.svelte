...
>
	<svg
		...
		stroke-width="12"
	>
		<g class="Tree stroke-black dark:stroke-white">
			<g class="troncs">
				<g class="tronc4">
					<g class="feuille4-24">
						<path
				...
				<g class="tronc2">
					<path
						...
						class="tronc2-12"
					/>
					<path  stroke-linecap="round" d="M400 233V131" class="tronc2-11" />
					<path
					...
					<path
						...
						class="tronc2-6"
					/>
					<path  stroke-linecap="round" d="M400 233V131" class="tronc2-5" />
					<path
				...
				<g class="tronc1">
					<path
						...
						class="tronc1-3"
					/>
					<path  stroke-linecap="round" d="M400 582.5V233" class="tronc1-2" />
					<path
