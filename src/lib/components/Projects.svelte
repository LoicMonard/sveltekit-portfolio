...
>
	<div class="container flex flex-col px-4">
		<div class="flex flex-col gap-2 lg:gap-4">
			<h1 class="text-4xl font-semibold text-text-light dark:text-text-dark lg:text-7xl">
				Crafted with love.
			</h1>
		...
		<div
			class="my-4 grid grid-cols-1 grid-rows-2 flex-col gap-4 lg:my-8 lg:grid-cols-4 lg:grid-rows-1 md:grid-cols-2 md:-grid-rows-2"
		>
